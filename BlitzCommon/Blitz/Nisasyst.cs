    ...
    public static class Nisasyst
    {
        ...
        public static void Decrypt(Stream inputStream, Stream outputStream, string gamePath)
        {
            ...
            using (AesManaged aesManaged = new AesManaged())
            {
                ...
                aesManaged.Key = CreateSequence(seadRandom);
                aesManaged.IV = CreateSequence(seadRandom);
                aesManaged.Padding = PaddingMode.None;

                using (CryptoStream cryptoStream = new CryptoStream(outputStream, aesManaged.CreateDecryptor(), CryptoStreamMode.Write, true))
                {
